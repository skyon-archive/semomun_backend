...
exports.create = (req, res) => {
  ...
  Workbook.bulkCreate(workbooks)
    ...
    .catch(err => {
      res.status(500).send({
        message:
          err.message || "Some error occurred while creating Workbooks."
      });
    });
    ...
    .catch(err => {
      res.status(500).send({
        message:
          err.message || "Some error occurred while creating Sections."
      });
    });
    var views = [];
    var problems = [];
    ...
    .catch(err => {
      res.status(500).send({
        message:
          err.message || "Some error occurred while creating Views."
      });
    });
    ...
    .catch(err => {
      res.status(500).send({
        message:
          err.message || "Some error occurred while creating Problems."
      });
    });
};
...
exports.preview = (req, res) => {
  ...
  if ( req.query.s!= undefined ) where["subject"] = {
    [Op.like]: req.query.s
  };
